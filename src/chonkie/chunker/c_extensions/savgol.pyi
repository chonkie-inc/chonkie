...
def windowed_cross_similarity(embeddings: list[list[float]], window_size: int) -> list[float]:
...
def get_cached_coeffs(window_size: int, poly_order: int, dtype: Optional[type] = None) -> None:
