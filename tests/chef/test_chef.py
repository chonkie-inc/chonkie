...
""".strip()
    ...
    def test_process_csv_file(
        self, table_chef: TableChef, csv_content: str, tmp_path, monkeypatch
    ) -> None:
    ...
    def test_process_excel_file(
        self, table_chef: TableChef, excel_df: pd.DataFrame, tmp_path, monkeypatch
    ) -> None:
    ...
    def test_process_markdown_table_string(
        self, table_chef: TableChef, markdown_table: str
    ) -> None:
        ...
        assert tables[0].content.strip() == markdown_table

    def test_process_batch(
        self, table_chef: TableChef, csv_content: str, tmp_path
    ) -> None:
        ...
        assert all(isinstance(r, str) and "| col1   | col2   |" in r for r in results)
    ...
    def test_call_invalid_type(self, table_chef: TableChef) -> None:
        """Test that TableChef raises TypeError on invalid input type."""
        with pytest.raises(TypeError, match="Unsupported type"):
            table_chef(123)  # type: ignore

    def test_extract_tables_from_markdown_multiple(self, table_chef: TableChef) -> None:
...
"""
    ...
    def test_repr(self, table_chef: TableChef) -> None:
...
class TestTextChef:
    ...
    def test_initialization(self, text_chef: TextChef) -> None:
    ...
    def test_process_single_file_string_path(
        self, text_chef: TextChef, sample_text: str
    ) -> None:
    ...
    def test_call_list_of_strings(self, text_chef: TextChef, sample_text: str) -> None:
    ...
    def test_call_tuple_of_paths(self, text_chef: TextChef, sample_text: str) -> None:
    ...
    def test_call_invalid_type_raises_error(self, text_chef: TextChef) -> None:
        """Test __call__ method with invalid input type raises TypeError."""
        with pytest.raises(TypeError, match="Unsupported type"):
            text_chef(123)

    def test_call_invalid_type_none_raises_error(self, text_chef: TextChef) -> None:
        """Test __call__ method with None raises TypeError."""
        with pytest.raises(TypeError, match="Unsupported type"):
            text_chef(None)

    def test_file_not_found_error(self, text_chef: TextChef) -> None:
        """Test handling of FileNotFoundError."""
        with patch("builtins.open", side_effect=FileNotFoundError("File not found")):
            with pytest.raises(FileNotFoundError):
                text_chef.process("nonexistent_file.txt")

    def test_permission_error(self, text_chef: TextChef) -> None:
        """Test handling of PermissionError."""
        with patch("builtins.open", side_effect=PermissionError("Permission denied")):
            with pytest.raises(PermissionError):
                text_chef.process("restricted_file.txt")

    def test_empty_file_content(self, text_chef: TextChef) -> None:
        """Test processing empty file."""
        with patch("builtins.open", mock_open(read_data="")):
            result = text_chef.process("empty_file.txt")
            assert result.content == ""

    def test_file_with_unicode_content(self, text_chef: TextChef) -> None:
    ...
    def test_repr_method(self, text_chef: TextChef) -> None:
        """Test __repr__ method returns correct string."""
