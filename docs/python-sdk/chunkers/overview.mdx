...
<CardGroup cols={2}>
  ...
  <Card
    ...
    icon="hashtags"
    href="/python-sdk/chunkers/markdown-chunker"
  >
    Splits Markdown using headings and separators, with optional cleanup. Great for docs and web content.
  </Card>
  <Card
    title="CodeChunker"
    icon="laptop"
  ...
  <Card
    title="TableChunker"
    icon="table-cells"
    href="/python-sdk/chunkers/table-chunker"
  >
