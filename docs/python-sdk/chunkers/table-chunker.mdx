...
## API Reference
To use the `TableChunker` via the API, check out the [API reference documentation](../../api-reference/table-chunker).
...
See also: [Chunkers Overview](/python-sdk/chunkers/overview)
