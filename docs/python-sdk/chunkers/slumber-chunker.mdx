...
>
    Initial recursive rules used to generate candidate split points before Genie refines them. See [RecursiveChunker](/python-sdk/chunkers/recursive-chunker#additional-information) for details.
</ParamField>
