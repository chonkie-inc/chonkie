...
<Cards>
  <Card title="Fetchers" href="/chonkie/fetchers/overview">
    Connect to data sources (files, APIs, databases)
  </Card>
  <Card title="Chefs" href="/chonkie/chefs/overview">
    Preprocess text, markdown, tables, etc.
  </Card>
  <Card title="Chunkers" href="/chonkie/chunkers/overview">
    Split text with various strategies
  </Card>
  <Card title="Refineries" href="/chonkie/refinery/overview">
    Add overlap, embeddings, and more
  </Card>
  <Card title="Porters" href="/chonkie/porters/overview">
    Export to JSON, Datasets, etc.
  </Card>
  <Card title="Handshakes" href="/chonkie/handshakes/overview">
...
<Steps>
  <Step title="Explore Fetchers">
    Learn how to connect different data sources in [Fetchers](/chonkie/fetchers/overview)
  </Step>
  <Step title="Choose Your Chunker">
    Find the right chunking strategy in [Chunkers](/chonkie/chunkers/overview)
  </Step>
  <Step title="Enhance with Refineries">
    Improve chunk quality in [Refineries](/chonkie/refinery/overview)
  </Step>
  <Step title="Store Your Chunks">
    Ingest into vector databases with [Handshakes](/chonkie/handshakes/overview)
  </Step>
</Steps>
