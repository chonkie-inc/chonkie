...
<Accordions>
<Accordion title="Python Example" description="Classes, functions, and imports are intelligently grouped" icon="python">
...
<Accordion title="JavaScript Example" description="Modules, functions, and classes are preserved" icon="js">

</Accordion>

<Accordion title="Rust Example" description="Modules, structs, and implementations are grouped" icon="rust">
