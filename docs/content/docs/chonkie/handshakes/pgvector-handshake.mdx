...
<Accordion title="Writing Chunks" description="Store your chunked text in PostgreSQL with vector embeddings" icon="upload">
...
<Accordion title="Searching Chunks" description="Find similar chunks using vector similarity search" icon="magnifying-glass">
...
<Accordion title="Creating Indexes" description="Optimize search performance with vector indexes" icon="bolt">
