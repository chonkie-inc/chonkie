...
Embeddings require the appropriate library to be installed. See the [Installation Guide](/chonkie/installation) for more information.
...
**Returns:** An instance of the appropriate embeddings handler of type `BaseEmbeddings`.
