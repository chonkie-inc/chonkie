...
1. **Process** them with a [Chef](/chonkie/chefs/overview) to parse content
2. **Chunk** them with a [Chunker](/chonkie/chunkers/overview) to split into manageable pieces
3. **Refine** chunks with [Refineries](/chonkie/refinery/overview) for better quality

See the [Pipeline Guide](/chonkie/pipelines) for complete examples.
