...
<Callout type="info">Batch processing is only supported in Python</Callout>
...
<Callout type="info">Custom tokenizers are only supported in Python. See the Installation section for JavaScript tokenizer support.</Callout>
...
<Callout type="info">The callable interface is only supported in Python</Callout>
...
<Callout type="info">Changing tokenizer backend is only supported on Python </Callout>
