...
<Tabs items={["Basic initialization with default parameters", "Split at paragraph boundaries", "Pattern-based splitting (e.g., for SentencePiece tokenizers)"]}>
<Tab value="Basic initialization with default parameters">
```python
