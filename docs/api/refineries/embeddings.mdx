...
api: "POST https://api.chonkie.ai/v1/refine/embeddings"
...
<ParamField path="embedding_model" type="string" default="minishlab/potion-retrieval-32M">
  The embedding model to use. Supports Hugging Face model identifiers.
</ParamField>
