...
<Tip>
  Before deleting, consider downloading the file as a backup in case you need it later.
</Tip>
...
<Warning>
  Deletion is permanent and cannot be undone. There is no "trash" or recovery mechanism. Make sure you want to delete the file before proceeding.
</Warning>

<Info>
  After deletion, search results are updated immediately. The file will no longer appear in search queries.
</Info>
...
<ResponseField name="500 Internal Server Error">
  Server error during deletion. File may or may not have been deleted. Check with [Get Knowledge Base Files](/api-reference/knowledge/get-files).
</ResponseField>
