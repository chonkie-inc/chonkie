---
title: "Upload Files"
api: "POST https://labs.chonkie.ai/api/v1/knowledge/{knowledge_base_slug}"
description: "Upload one or more files to a knowledge base"
---

Upload files to a knowledge base for indexing and semantic search. Files are automatically chunked, embedded, and indexed.
