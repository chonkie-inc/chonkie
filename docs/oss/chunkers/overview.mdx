...
<CardGroup cols={2}>
  ...
  <Card
    title="SDPMChunker"
    icon="layer-group"
    href="/oss/chunkers/sdpm-chunker"
  >
    Chunks using Semantic Double-Pass Merging (SDPM) algorithm, best for
    maintaining topical coherence when text has frequent breaks.
  </Card>
