...
| FastChunker      |   <Icon icon="x" color="#ff0000" iconType="solid" />   |   <Icon icon="x" color="#ff0000" iconType="solid" />   | <Icon icon="check" color="#005c00" iconType="solid" /> |   <Icon icon="x" color="#ff0000" iconType="solid" />   |   <Icon icon="x" color="#ff0000" iconType="solid" />   |
