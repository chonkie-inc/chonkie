...
# │                           [default: semantic]                                                                  │
# │ --chunk-size        INT   Maximum number of tokens per chunk                                                   │
# │ --chunk-overlap      INT   Number of tokens to overlap between chunks                                           │
# │ --threshold         FLOAT  Threshold for semantic similarity (0-1)                                            │
# │ --chunker-params    TEXT   Additional parameters for the chunker as key=value pairs (can be used multiple      │
# │                           times, e.g., --chunker-params tokenizer=gpt2 --chunker-params min_characters_per_chunk=50) │
...
# │ --chef-params       TEXT  Parameters for the chef as key=value pairs (can be used multiple times)               │
...
# │ --refiner-params    TEXT  Parameters for the refiner as key=value pairs (can be used multiple times)             │
# │ --handshaker        TEXT  Handshaker method to use                                                             │
# │ --handshaker-params TEXT  Parameters for the handshaker as key=value pairs (can be used multiple times)        │
# │ --help                    Show this message and exit.                                                          │
# ╰────────────────────────────────────────────────────────────────────────────────────────────────────────────────╯
