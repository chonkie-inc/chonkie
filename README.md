...
<details>
<summary><strong>🧞‍♂️ Power Up with Genies! Chonkie supports 4+ LLM providers!</strong></summary>
...
| `cohere`     | `CohereGenie` | Interact with Cohere's Command models. | `chonkie[cohere]`   |
